// $Id: customborderbuilder.h 4652 2009-03-29 10:10:02Z FloSoft $
//
...
#include <stdio.h> // ohne lädt libsiedler2.h nicht!
...
{
public:
  CustomBorderBuilder(const ArchivItem_Palette * const palette);
  ~CustomBorderBuilder();
  int loadEdges(ArchivInfo* archiveInfo);
  int buildBorder(const unsigned int width, const unsigned int height,
