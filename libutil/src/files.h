// $Id: files.h 4652 2009-03-29 10:10:02Z FloSoft $
//
...
const char * const FILE_PATHS[] =
{
	...
	/* 13 */GAMEDIR "/DATA/TXT/ONGAME.", // GER,ENG,...
	/* 14 */GAMEDIR "/DATA/TXT/NAMES.", // GER,ENG,...
	/* 15 */RTTRDIR "/languages", // GER,ENG,...
	/* 16 */RTTRDIR "/RTTR.LST",
	/* 17 */RTTRDIR "/COLORS.ACT",
	/* 18 */RTTRDIR "/CLIENT.GER",
	/* 19 */GAMEDIR "/GFX/PICS/SETUP997.LBM",
	...
	/* 55 */SETTINGSDIR "/sound.lst", // die konvertierte sound.lst
...
/// Menühintergründe
const char * const FP_MENU_BACKGROUNDS[] =
{
	/*	0 */RTTRDIR "/pics/menu.bmp", // Hauptmenü
	/*	1 */GAMEDIR "/GFX/PICS/SETUP013.LBM", // Optionen
	/*	2 */GAMEDIR "/GFX/PICS/SETUP015.LBM", // Freies Spiel
	/*	3 */RTTRDIR "/pics/splash.bmp", // Splash
};
