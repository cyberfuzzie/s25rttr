// $Id: nobUsual.cpp 6582 2010-07-16 11:23:35Z FloSoft $
//
...
void nobUsual::Draw(int x,int y)
{
	...
	else if(type == BLD_DONKEYBREEDER)
	{
		...
		// X-Position der Esel
		const int DONKEY_X[4][3] = {{13,26,39},{3,16,30},{2,15,29},{7,18,30},};
		// Y-Position
		const int DONKEY_Y[4] = {-9,-17,-21,-17};
