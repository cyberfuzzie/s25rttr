// $Id: LobbyMessageInterface.cpp 4652 2009-03-29 10:10:02Z FloSoft $
//
 ...
 *  @author FloSoft
 */
void LobbyMessageInterface::OnNMSLobbyRegister(unsigned int id, const std::string &user, const std::string &pass, const std::string &email)
{
}
