// $Id: nofHunter.cpp 5253 2009-07-12 14:42:18Z FloSoft $
//
	...
	case STATE_HUNTER_SHOOTING:
		{
			if(shooting_dir == 3)
			{
				...
				LOADER.GetImageN("rom_bobs", 219+id)->Draw(x,y,0,0,0,0,0,0, COLOR_WHITE, COLORS[GAMECLIENT.GetPlayer(player)->color]);
			...
			else
			{
				...
				LOADER.GetImageN("rom_bobs", 1686+((shooting_dir+2)%6)*8+id)->Draw(x,y,0,0,0,0,0,0, COLOR_WHITE, COLORS[GAMECLIENT.GetPlayer(player)->color]);
