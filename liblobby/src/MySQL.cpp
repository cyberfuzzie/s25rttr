// $Id: MySQL.cpp 6460 2010-05-31 11:42:38Z FloSoft $
//
...
bool MySQL::DoQuery(std::string query)
{
	...
	{
		LOG.lprintf("Failed to send query to database: Error: %s\n", mysql_error(m_pMySQL));
		return false;
	}
	return true;
}
