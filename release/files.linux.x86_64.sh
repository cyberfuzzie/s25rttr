...
cp -v /usr/x86_64-pc-linux-gnu/lib/libminiupnpc.so.5 lib/
...
# copy to target
if [ ! -z "$TARGET" ] ; then
	#reprepro -Vb $TARGET/deb remove hardy s25rttr
	reprepro -Vb $TARGET/deb includedeb hardy ../../deb/s25rttr_${VERSION}_${PKGARCH}.deb
