...
public:
	...
	void IncreaseSpeed() { if(framesinfo.gf_length>10) {framesinfo.gf_length-=10;framesinfo.nwf_length=250/framesinfo.gf_length;}
#ifndef NDEBUG
		else if (framesinfo.gf_length == 10) {framesinfo.gf_length=1;framesinfo.nwf_length=50;}
#endif
		else {framesinfo.gf_length=70;framesinfo.nwf_length=250/framesinfo.gf_length;}} //poc
